...
#ifndef ASLAM_CALIBRATION_CAR_ERROR_TERM_ANGULAR_VELOCITY_H
#define ASLAM_CALIBRATION_CAR_ERROR_TERM_ANGULAR_VELOCITY_H
...
namespace aslam {
  namespace calibration {
    ...
    /** The class ErrorTermWheel implements an error term for a wheel.
      ...
      */
    class ErrorTermAngularVelocity :
    ...
    public:
       ...
       */
      ErrorTermAngularVelocity(const aslam::backend::EuclideanExpression& r_w_mr,
                               const aslam::backend::EuclideanExpression& r_w_mr_m,
                               const Covariance& sigma2_vel_z);
      /// Copy constructor
      ErrorTermAngularVelocity(const ErrorTermAngularVelocity& other);
      /// Assignment operator
      ErrorTermAngularVelocity& operator = (const ErrorTermAngularVelocity& other);
      /// Destructor
      virtual ~ErrorTermAngularVelocity();
      /** @}
        */
    ...
    protected:
       ...
       */
      aslam::backend::EuclideanExpression _r_w_mr;
      aslam::backend::EuclideanExpression _r_w_mr_m;
      /// Covariance of the measurement
      Covariance _sigma2_ang_velZ;
      /** @}
        */
...
#endif // ASLAM_CALIBRATION_CAR_ERROR_TERM_ANGULAR_VELOCITY_H
